...
const App = () => {
  const [props, setProps]: any = useState(initialState);

  return (
    <>
      <StatusBar barStyle="dark-content" />
      <AppContext.Provider value={{props, setProps} as any}>
        <NavigationContainer>
          <Stack.Navigator>
...
const HomeScreen = ({navigation}: any) => {
  const {props, setProps}: any = useContext(AppContext);
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                _checkPermissions(async () => {
                  ...
                  setProps({...props, token: data.token});
                  navigation.navigate('Video Call');                 

                  // fetch(`${API_URL}/getToken?userName=${props.userName}&roomName=${props.roomName}`)
                  //   .then(response => {
